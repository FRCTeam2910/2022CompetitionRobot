...
public class GeomUtil {
     ...
     *
     * @param x
     *            The x componenet of the translation
     * @param y
     *            The y componenet of the translation
     * @return The resulting transform
     */
     ...
     * would result in the first pose, t=1 would result in the last pose, and t=0.5
     * would result in a pose which is exactly halfway between the two poses. Values
     * of t less than zero return the first pose, and values of t greater than 1
     * return the last pose.
     *
     * @param lhs
     *            The left hand side, or first pose to use for interpolation
     * @param rhs
     *            The right hand side, or last pose to use for interpolation
     * @param t
     *            The scale factor, 0 <= t <= 1
     * @return The pose which represents the interpolation. For t <= 0, the "lhs"
     *         parameter is returned directly. For t >= 1, the "rhs" parameter is
     *         returned directly.
     */
