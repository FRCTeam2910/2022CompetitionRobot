...
public class AutonomousTrajectories {
    ...
    // private static final String EIGHT_BALL_AUTO_PART_ONE_NAME =
    // "autos/8BallAuto/8BallAutoPart1.path";
    // private static final String EIGHT_BALL_AUTO_PART_TWO_NAME =
    // "autos/8BallAuto/8BallAutoPart2.path";
    // private static final String TEN_BALL_AUTO_PART_ONE_NAME =
    // "autos/10BallAuto/10BallAutoPart1.path";
    // private static final String TEN_BALL_AUTO_PART_TWO_NAME =
    // "autos/10BallAuto/10BallAutoPart2.path";
    ...
    public AutonomousTrajectories(TrajectoryConstraint[] trajectoryConstraints) throws IOException {
        ...
        // new SimplePathBuilder(new Vector2(-111.9, 61.8),
        // Rotation2.fromDegrees(-21.0))
        // .arcTo(new Vector2(-159.8, 109.6), new Vector2(-82.0, 139.6),
        // Rotation2.fromDegrees(-21.0))
        ...
        taxiRedRapidReactPartOne = new Trajectory(
                new SimplePathBuilder(new Vector2(-111.9, 61.8), Rotation2.fromDegrees(-21.0))
                        .lineTo(new Vector2(-151.9, 101.8)).build(),
                trajectoryConstraints, SAMPLE_DISTANCE);

        // taxiBlueRapidReactPartOne = new Trajectory(
        // new SimplePathBuilder(new Vector2(-29.0, -124.5),
        // Rotation2.fromDegrees(69.0))
        // .arcTo(new Vector2(-24.6, -192.6), new Vector2(47.5, -153.8),
        // Rotation2.fromDegrees(69.0))
        ...
        taxiBlueRapidReactPartOne = new Trajectory(
                new SimplePathBuilder(new Vector2(-29.0, -124.5), Rotation2.fromDegrees(69.0))
                        .lineTo(new Vector2(-69.0, -164.5)).build(),
                trajectoryConstraints, SAMPLE_DISTANCE);

        // eightBallAutoPartOne = new Trajectory(new SimplePathBuilder(new
        // Vector2(509.0, -162.0), Rotation2.ZERO)
        // .lineTo(new Vector2(468.0, -67.34)).build(), trajectoryConstraints,
        // SAMPLE_DISTANCE);
        // eightBallAutoPartTwo = new Trajectory(
        // new SimplePathBuilder(new Vector2(468.0, -67.34), Rotation2.ZERO).lineTo(new
        // Vector2(459.23, -111.87))
