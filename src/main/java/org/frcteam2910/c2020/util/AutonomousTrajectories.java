...
public class AutonomousTrajectories {
    ...
    private static final Path EIGHT_BALL_COMPATIBLE_PART_ONE = new SimplePathBuilder(new Vector2(511.75, -148.0),
    ...
    private static final Path EIGHT_BALL_COMPATIBLE_PART_FOUR = new SimplePathBuilder(new Vector2(474.0, -114.25),
            Rotation2.fromDegrees(14.0)).lineTo(new Vector2(324.0, -134.25), Rotation2.fromDegrees(0.0)).build();
    ...
    public AutonomousTrajectories(TrajectoryConstraint[] trajectoryConstraints) throws IOException {
        ...
        eightBallAutoPartOne = new Trajectory(new SimplePathBuilder(new Vector2(509.0, -155.0), Rotation2.ZERO)
        ...
        eightBallAutoPartFour = new Trajectory(
                new SimplePathBuilder(new Vector2(468.0, -67.34), Rotation2.fromDegrees(0.0))
                        .arcTo(new Vector2(324, -134.25), new Vector2(324.0, 54.16)).build(),
                trajectoryConstraints, SAMPLE_DISTANCE);
        ...
        eightBallCompatiblePartThree = new Trajectory(EIGHT_BALL_COMPATIBLE_PART_THREE, trajectoryConstraints,
                SAMPLE_DISTANCE);
        eightBallCompatiblePartFour = new Trajectory(EIGHT_BALL_COMPATIBLE_PART_FOUR, trajectoryConstraints,
                SAMPLE_DISTANCE);

        simpleShootThree = new Trajectory(
                new SimplePathBuilder(Vector2.ZERO, Rotation2.ZERO).lineTo(new Vector2(40.0, 0.0)).build(),
                trajectoryConstraints, SAMPLE_DISTANCE);
    }
