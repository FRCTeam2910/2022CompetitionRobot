...
public class VisionSubsystem implements Subsystem {
    ...
    public VisionSubsystem(DrivetrainSubsystem drivetrainSubsystem) {
        ...
        tab.addBoolean("Intake Has Target", () -> intakeHasTarget).withPosition(0, 1).withSize(1, 1);
        tab.addNumber("Intake Distance to Target", () -> intakeDistanceToTarget).withPosition(1, 1).withSize(1, 1);
        tab.addNumber("X-Coord Distance to Target", () -> xFromTarget).withPosition(2, 1).withSize(1, 1);
        tab.addNumber("Y-Coord Distance To Target", () -> yFromTarget).withPosition(3, 1).withSize(1, 1);
    }
