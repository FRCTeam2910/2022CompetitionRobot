...
public class TargetWithShooterCommand extends CommandBase {
    ...
    static {
        ...
        SHOOTER_TUNING.put(new InterpolatingDouble(1.0),
                new Vector2(Math.toRadians(6.0), Units.rotationsPerMinuteToRadiansPerSecond(1725)));
        SHOOTER_TUNING.put(new InterpolatingDouble(1.5),
                new Vector2(Math.toRadians(8.5), Units.rotationsPerMinuteToRadiansPerSecond(1825)));
        SHOOTER_TUNING.put(new InterpolatingDouble(2.0),
                new Vector2(Math.toRadians(11.0), Units.rotationsPerMinuteToRadiansPerSecond(1900)));
        SHOOTER_TUNING.put(new InterpolatingDouble(2.5),
                new Vector2(Math.toRadians(12.5), Units.rotationsPerMinuteToRadiansPerSecond(1950)));
        SHOOTER_TUNING.put(new InterpolatingDouble(3.0),
                new Vector2(Math.toRadians(14.5), Units.rotationsPerMinuteToRadiansPerSecond(2025)));
        ...
        SHOOTER_TUNING.put(new InterpolatingDouble(4.5),
                new Vector2(Math.toRadians(22.0), Units.rotationsPerMinuteToRadiansPerSecond(2250)));
        SHOOTER_TUNING.put(new InterpolatingDouble(5.0),
                new Vector2(Math.toRadians(24.0), Units.rotationsPerMinuteToRadiansPerSecond(2325)));
        SHOOTER_TUNING.put(new InterpolatingDouble(5.5),
                new Vector2(Math.toRadians(25.5), Units.rotationsPerMinuteToRadiansPerSecond(2425)));
        SHOOTER_TUNING.put(new InterpolatingDouble(6.0),
                new Vector2(Math.toRadians(27.5), Units.rotationsPerMinuteToRadiansPerSecond(2575)));
