...
public class CircleFitter {
    ...
    public static Translation2d fit(double radius, List<Translation2d> points, double precision) {
        ...
        while (true) {
            List<Translation2d> translations = List.of(new Translation2d(shiftDist, 0.0),
                    new Translation2d(-shiftDist, 0.0), new Translation2d(0.0, shiftDist),
    ...
    private static double calcResidual(double radius, List<Translation2d> points, Translation2d center) {
        double residual = 0.0;
        for (Translation2d point : points) {
