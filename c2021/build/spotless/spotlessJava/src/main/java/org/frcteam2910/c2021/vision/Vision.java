...
import org.frcteam2910.c2021.FieldConstants;
import org.frcteam2910.c2021.VisionConstants;
...
public class Vision extends SubsystemBase {
    ...
    private Supplier<VisionLedMode> modeSupplier = () -> VisionLedMode.ALWAYS_ON;
    private Supplier<Boolean> climbModeSupplier = () -> false;
    ...
    public void setSuppliers(Supplier<VisionLedMode> modeSupplier, Supplier<Boolean> climbModeSupplier) {
        this.modeSupplier = modeSupplier;
        this.climbModeSupplier = climbModeSupplier;
    }

    public void setTranslationConsumer(Consumer<TimestampedTranslation2d> translationConsumer) {
    ...
    public void periodic() {
        ...
        if (targetCount >= minTargetCount) {
            ...
            if (cameraToTargetTranslations.size() >= minTargetCount * 4) {
                ...
                translationConsumer.accept(new TimestampedTranslation2d(inputs.captureTimestamp - extraLatencySecs,
